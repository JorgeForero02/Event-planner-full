    ...
    getEmpresaUsuario = async () => {
        try {
            ...
            if (profileResult.success) {
                ...
                if (profileResult.data?.usuario?.rolData?.empresa?.id) {
                    empresaId = profileResult.data.usuario.rolData.empresa.id;
                }
                else if (profileResult.data?.usuario?.rolData?.id_empresa) {
                    empresaId = profileResult.data.usuario.rolData.id_empresa;
                }
